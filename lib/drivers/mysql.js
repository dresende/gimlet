...
exports.create = function (pkg, uri) {
	return new Driver(require(pkg).createConnection(uri));
};
...
Driver.prototype.transaction = function () {
	this.connection.beginTransaction.apply(this.connection, arguments);
};
